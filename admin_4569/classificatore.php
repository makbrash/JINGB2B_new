...
<head>
    ...
    <!-- Stili CSS -->
    <link rel="stylesheet" href="assets/css/classificatore.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="toolbar">
            <div class="toolbar-group">
                ...
                <button id="btn-fetch-images" class="button button-primary">🖼️ Recupera immagini</button>
    ...
    <!-- JavaScript -->
    <script src="assets/js/classificatore.js"></script>
